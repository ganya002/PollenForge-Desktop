...
export default function UpdatesPanel() {
  ...
  return (
    <div className="space-y-4">
      ...
      {latest?.body && status.status === 'available' && (
        <div className="bg-surface-2 rounded-lg p-4">
          <div className="text-xs font-medium text-text-primary mb-2">Latest notes</div>
          <div className="text-[11px] text-text-secondary leading-relaxed max-h-32 overflow-y-auto">
      ...
      <div>
        ...
        {listError && <p className="text-[11px] text-red-400 mb-2">{listError}</p>}
              ...
              <div key={release.tag} className="bg-surface-2 rounded-lg p-3">
                ...
                {release.body && (
                  <details className="mt-2">
                    ...
                    <div className="text-[11px] text-text-secondary mt-2 max-h-28 overflow-y-auto">
