...
export const PROVIDER_CATALOG: ProviderCatalogEntry[] = [
  ...
  },
  {
    ...
    models: [
      m('anthropic/claude-3.5-sonnet', 'Claude 3.5 Sonnet', 0.003, 200000),
      m('openai/gpt-4o', 'GPT-4o', 0.005),
      m('openai/gpt-4o-mini', 'GPT-4o Mini', 0.00015),
      m('deepseek/deepseek-v3', 'DeepSeek V3', 0.00027),
      m('qwen/qwen-2.5-coder-32b-instruct', 'Qwen 2.5 Coder 32B', 0.0002),
      m('google/gemini-2.0-flash-exp:free', 'Gemini 2.0 Flash', 0.0001, 1048576),
    ],
  },
  {
    id: 'ollama',
